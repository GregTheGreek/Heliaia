...
var prompts = /*#__PURE__*/require('prompts');

var Proxy = /*#__PURE__*/function () {
  function Proxy(provider, ruleEngine) {
  ...
  _proto.rpcHandler = /*#__PURE__*/function () {
    var _rpcHandler = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(method, params) {
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.t0 = method;
              _context.next = _context.t0 === 'eth_sendRawTransaction' ? 3 : 4;
              break;

            case 3:
              return _context.abrupt("return", this.transactionHandler(params));

            case 4:
              return _context.abrupt("return", this.provider.send(method, params));
    ...
    function rpcHandler(_x, _x2) {
      return _rpcHandler.apply(this, arguments);
    }

    return rpcHandler;
  }();

  _proto.transactionHandler = /*#__PURE__*/function () {
    var _transactionHandler = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(params) {
      var tx;
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              tx = ethers.utils.parseTransaction(params[0]); // Run all rules

              _context2.next = 3;
              return this.ruleEngine.run(tx);
            ...
            case 8:
              ...
              return _context2.abrupt("return", this.provider.send('eth_sendRawTransaction', params));
    ...
    function transactionHandler(_x3) {
      return _transactionHandler.apply(this, arguments);
    }

    return transactionHandler;
  }();

  _proto.showPrompt = /*#__PURE__*/function () {
    var _showPrompt = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3() {
      var response;
...
var RuleEngine = /*#__PURE__*/function () {
  function RuleEngine(rules) {
    ...
    rules.map(function (x) {
      return _this.addRule(x);
    });
  }

  var _proto = RuleEngine.prototype;

  _proto.addRule = function addRule(rule) {
...
var options = /*#__PURE__*/program.opts(); // Setup proxy and rules
  ...
  var _ref = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(req, res) {
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _req$body = req.body, id = _req$body.id, method = _req$body.method, params = _req$body.params;
            _context.prev = 1;
            _context.next = 4;
            return proxy.rpcHandler(method, params);
          ...
          case 8:
            ...
            if ((_context.t0 == null ? void 0 : _context.t0.body) !== undefined) {
              _JSON$parse = JSON.parse(_context.t0.body), error = _JSON$parse.error;
              res.json({
                jsonrpc: "2.0",
                id: id,
                error: error
...
app.listen(parseInt(options.port), function () {
  console.log("Listening on port " + options.port);
});
//# sourceMappingURL=heliaia.cjs.development.js.map
